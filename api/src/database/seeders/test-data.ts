...
export const up = async (queryInterface: QueryInterface) => {
  ...
  const mainUser = {
    id: randomUUID(),
    email: 'test@mail.com',
    password: '$2b$10$CyaUlxwv6dYHTKfja/VRKOgtlbgQImyBaS7uzlIpjjl29CH2N0JgC',
  };
  ...
  booksGenres.push({
    id: randomUUID(),
    bookId: book2.id,
    genreId: genreSuspense.id,
  });
  booksGenres.push({
    id: randomUUID(),
    bookId: book2.id,
    genreId: genreFiccao.id,
  });
  booksGenres.push({
    id: randomUUID(),
    bookId: book2.id,
    genreId: genreThrillerPsi.id,
  });
  booksGenres.push({
    id: randomUUID(),
    bookId: book2.id,
  ...
  booksGenres.push({
    id: randomUUID(),
    bookId: book2.id,
    genreId: genreSaga.id,
  });
  booksGenres.push({
    id: randomUUID(),
    bookId: book2.id,
    genreId: genreMisterio.id,
  });
  ...
  const book3 = {
    ...
    publishedYear: 2017,
    bannerImageUrl:
      'https://m.media-amazon.com/images/I/81LRk6+p1HL._SY425_.jpg',
  ...
  const book4 = {
    ...
    publishedYear: 2023,
    bannerImageUrl:
      'https://m.media-amazon.com/images/I/81E9scx1JBL._SY425_.jpg',
  ...
  const book5 = {
    ...
    publishedYear: 2022,
    bannerImageUrl:
      'https://m.media-amazon.com/images/I/616U6mSP3lL._SY425_.jpg',
    editorName: 'Faro Editorial',
    languageId: languagePt.id,
    pageCount: 256,
  };
  ...
  const book6 = {
    ...
    publishedYear: 2014,
    bannerImageUrl:
      'https://m.media-amazon.com/images/I/71bJYZfcrKL._SY425_.jpg',
    editorName: 'Seguinte',
    languageId: languagePt.id,
    pageCount: 272,
  };
  ...
  const book7 = {
    ...
    publishedYear: 2021,
    bannerImageUrl:
      'https://m.media-amazon.com/images/I/71X245OYRBL._SY425_.jpg',
    editorName: 'Galera',
    languageId: languagePt.id,
    pageCount: 504,
  };
  ...
  const book8 = {
    ...
    publishedYear: 2013,
    bannerImageUrl:
      'https://m.media-amazon.com/images/I/71da0pEmHoL._SY425_.jpg',
  ...
  const book9 = {
    ...
    publishedYear: 2022,
    bannerImageUrl:
      'https://m.media-amazon.com/images/I/81fyJqqSEIL._SY425_.jpg',
